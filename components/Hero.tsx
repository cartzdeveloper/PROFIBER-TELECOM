      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center">
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left mb-12 lg:mb-0">
          ...
          <img 
            ...
            className="h-20 md:h-24 mb-8 mx-auto lg:mx-0"
          />

          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-900/40 border border-blue-500/30 text-blue-300 text-sm font-semibold mb-6">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-white mb-6 leading-tight">
            {selectedPlan ? (
              <>
                Você escolheu o <br/>
                <span className="bg-gradient-to-r from-profiber-sky to-blue-600 gradient-text text-transparent">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
            <a 
              ...
              className="inline-flex items-center justify-center px-8 py-4 border border-transparent text-base font-bold rounded-full text-white bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 shadow-lg shadow-blue-500/40 transform hover:-translate-y-1 transition-all duration-200"
            >
            ...
            {!selectedPlan && (
              <a 
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center justify-center px-8 py-4 border border-white/10 text-base font-medium rounded-full text-white bg-white/5 hover:bg-white/10 backdrop-blur-sm transition-all"
              >
                Falar no WhatsApp
              </a>
            )}
        ...
        <div className="w-full lg:w-1/2 relative perspective-1000">
           <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-blue-900/50 border border-white/10 group transform transition-transform duration-500 hover:rotate-y-2">
             ...
             {/* Floating Badge */}
             <div className="absolute bottom-6 left-6 z-20 bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-xl flex items-center gap-4">
                <div className="p-3 bg-profiber-royal rounded-lg">
                  {selectedPlan ? <CheckCircle2 className="w-6 h-6 text-white" /> : <Wifi className="w-6 h-6 text-white" />}
                </div>
                <div>
                  <p className="text-gray-300 text-xs">{selectedPlan ? "Plano Selecionado" : "Status da Rede"}</p>
