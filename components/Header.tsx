...
export const Header: React.FC = () => {
  ...
  const navLinks = [
    { name: 'Início', href: '#home', title: 'Página Inicial Profiber' },
    { name: 'Planos', href: '#plans', title: 'Planos de Internet Fibra Óptica' },
    { name: 'Cobertura', href: '#coverage', title: 'Cidades Atendidas pela Profiber' },
    { name: 'Vantagens', href: '#benefits', title: 'Por que escolher a Profiber' },
    { name: 'Dúvidas', href: '#faq', title: 'Perguntas Frequentes' },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            ...
            <div className="flex-shrink-0 flex items-center">
              <a href="#" className="flex items-center gap-2 group" title="Profiber Telecom - Voltar ao Topo">
                <img 
                  src="https://i.ibb.co/pvNn2Rcv/IMG-1778.png" 
                  alt="Profiber Telecom Logo - Especialista em Fibra Óptica" 
            ...
            <nav className="hidden md:flex items-center space-x-1" role="navigation" aria-label="Menu Principal">
              ...
              <a 
                ...
                target="_blank"
                rel="noreferrer"
                title="Assinar plano via WhatsApp"
          ...
          <div className="p-4 space-y-2">
            ...
            <div className="pt-2 mt-2 border-t border-white/10 space-y-3">
              ...
              <a 
                 ...
                 target="_blank"
                 rel="noreferrer"
                 title="Fale com um consultor agora"
